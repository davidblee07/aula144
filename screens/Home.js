...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      movieDetails: {},
      ngrok_url: "https://1d22-2804-56c-c1f3-4800-9967-66b4-dd3c-1a10.ngrok.io",
    };
  }
...
componetDidMount(){
  ...
  render() {
    if(this.state.movieDetails.poster_link){
      const {poster_link, original_title, release_date, duration, rating} = this.state.movieDetails
    return (
          ...
          <View style={styles.subContainer}>
            ...
            <View style={styles.iconButtonContainer}>
              <TouchableOpacity onPress={this.likeMovie}>
                <Image source={require('../assets/like.png')} style={styles.iconImage}></Image>
              </TouchableOpacity>
              <TouchableOpacity onPress={this.dislikedMovie}>
                <Image source={require('../assets/dislike.png')} style={styles.iconImage}></Image>
              </TouchableOpacity>
              <TouchableOpacity onPress={this.didNotWatchMovie}>
                <Image source={require('../assets/didNotWatch.png')} style={styles.iconImage} ></Image>
              </TouchableOpacity>
            </View>
          </View>
        </ImageBackground>
